# Project OCI (Oracle Cloud Infrastructure)
...
Imagine a terraform IAM project that decided to go on a neon-lit joyride through a dystopian future to add an OCI user for John Menerick. That's me. I code with one hand on the keyboard and the other holding a digital katana.
...
**Remember, in Project OCI, the future is now, and it's oddly Terraform-like.**
